...
# Create Dropdownbox
start_combo = ttk.Combobox(root, values=HrSel, width=10, height=4, font=('Helvetica', 12))  # Adjust font size as needed
start_combo.place(x=130, y=12)  # Adjust the coordinates for indentation
