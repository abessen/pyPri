...
style.configure('Custom.TCombobox', fieldbackground='gray')  # Set background color to gray
...
start_combo2.place(x=440, y=10)  # Adjust the coordinates for indentation
