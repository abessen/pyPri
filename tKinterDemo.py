...
# Create Dropdownbox
start_combo = ttk.Combobox(root, values=HrSel, width=10, height=5)  # Adjust width and height as needed
start_combo.place(x=100, y=11)  # Adjust the coordinates for indentation
