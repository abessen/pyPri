...
# Create Dropdownbox
start_combo = ttk.Combobox(root, values=HrSel, width=9, height=2.5, font=('Helvetica', 10))  # Adjust font size as needed
start_combo.place(x=136, y=12)  # Adjust the coordinates for indentation
