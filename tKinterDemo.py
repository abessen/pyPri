...
# Create Dropdownbox
start_combo = ttk.Combobox(root, values=HrSel, width=9, height=2, font=('Helvetica', 12))  # Adjust font size as needed
start_combo.place(x=140, y=11)  # Adjust the coordinates for indentation
