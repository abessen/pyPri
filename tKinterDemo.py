...
# Create Dropdownbox
start_combo = ttk.Combobox(root, values=HrSel, width=10, height=3, font=('Helvetica', 10))  # Adjust font size as needed
start_combo.place(x=132, y=12)  # Adjust the coordinates for indentation
